...
class Review(models.Model):
    ...
    latitude = models.FloatField(max_length=20, default="37.4192008972")
    longitude = models.FloatField(max_length=20, default="-122.057403564")
...
class Cart(models.Model):
    ...
    payment_style = models.CharField(max_length=100, null=True)
